...
npx expo login          # @intellme
eas init                # create or link @intellme/savr
...
eas env:create --scope project --environment production --name EXPO_PUBLIC_API_URL --value https://savr-eta.vercel.app
...
3. Privacy: https://savr-eta.vercel.app/privacy
4. Terms: https://savr-eta.vercel.app/terms
