  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-32 pb-20 md:pt-44 md:pb-32 overflow-hidden">
        ...
        {/* Decorative orbs */}
        <div className="absolute top-20 left-1/4 h-96 w-96 rounded-full opacity-20 animate-pulse-glow" style={{ background: 'radial-gradient(circle, rgba(127, 163, 122, 0.18), transparent 70%)' }} />
        <div className="absolute bottom-10 right-1/4 h-80 w-80 rounded-full opacity-15 animate-pulse-glow" style={{ background: 'radial-gradient(circle, rgba(166, 190, 162, 0.16), transparent 70%)', animationDelay: '1.5s' }} />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            {/* Badge */}
            <div className="mb-8 inline-flex items-center gap-2 rounded-full px-4 py-2" style={{ background: 'var(--color-primary-light)', border: '1px solid var(--color-border-strong)' }}>
              <span className="h-2 w-2 rounded-full" style={{ background: 'var(--color-primary)', boxShadow: '0 0 8px rgba(127, 163, 122, 0.45)' }} />
            ...
            {/* Sub-headline */}
            <p className="mx-auto mb-10 max-w-2xl text-base leading-relaxed text-foreground-muted sm:text-lg md:text-xl">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 md:mb-20">
            ...
            <p className="text-2xl sm:text-3xl md:text-5xl font-bold text-foreground leading-tight">
              ...
              <span className="gradient-text">cook like a pro</span>
            </p>
          </div>
      ...
      <section className="relative py-16 md:py-20">
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl p-6 md:p-8" style={{ background: 'linear-gradient(135deg, rgba(185, 153, 113, 0.1), rgba(185, 153, 113, 0.03))', border: '1px solid rgba(185, 153, 113, 0.22)' }}>
            <div className="flex items-start gap-4">
              <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl md:h-12 md:w-12" style={{ background: 'rgba(185, 153, 113, 0.14)' }}>
                <svg className="h-6 w-6 text-pet" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                <h3 className="mb-2 text-base font-semibold text-pet md:text-lg">Pet Recipe Safety</h3>
                ...
                <p className="text-xs text-foreground-muted">
                  ...
                  <Link href="/faq" className="text-pet hover:underline">Learn more in our FAQ</Link>.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-24 md:py-32">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="absolute left-1/2 top-1/2 hidden h-px w-[60%] -translate-x-1/2 md:block" style={{ background: 'linear-gradient(to right, transparent, rgba(127, 163, 122, 0.22), rgba(166, 190, 162, 0.22), transparent)', marginTop: '20px' }} />
        </div>
      </section>

      {/* CTA Section */}
      <section className="relative py-24 md:py-32 overflow-hidden">
        <div className="absolute inset-0" style={{ background: 'linear-gradient(135deg, rgba(127, 163, 122, 0.08), rgba(166, 190, 162, 0.06))' }} />
        <div className="absolute inset-0 bg-grid" />
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mx-auto mb-10 max-w-2xl text-base text-foreground-muted sm:text-lg md:text-xl">
          ...
          <div className="mt-12 inline-flex items-center gap-3 rounded-full px-5 py-3" style={{ background: 'rgba(166, 190, 162, 0.12)', border: '1px solid rgba(166, 190, 162, 0.22)' }}>
            <svg className="h-5 w-5 text-accent" fill="none" stroke="currentColor" strokeWidth={1.75} viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
            </svg>
            <span className="text-sm font-medium text-accent">Mobile app coming soon</span>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex items-center gap-8">
              <Link href="/pricing" className="text-sm text-foreground-muted transition-colors hover:text-primary">
                Pricing
              </Link>
              <Link href="/faq" className="text-sm text-foreground-muted transition-colors hover:text-primary">
                FAQ
              </Link>
...
function Step({ number, title, description, icon }: { number: string; title: string; description: string; icon: React.ReactNode }) {
  return (
    <div className="relative text-center group">
      <div className="glow-primary mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl md:mb-5 md:h-16 md:w-16" style={{ background: 'var(--color-primary-light)', border: '1px solid var(--color-border)' }}>
        <div className="h-6 w-6 text-primary md:h-7 md:w-7">{icon}</div>
      </div>
