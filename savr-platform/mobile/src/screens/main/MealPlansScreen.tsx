      ...
      <FlatList
        ...
        renderItem={({ item }) => {
          ...
          const mealsByDate = (item.meals ?? []).reduce((dateAcc, meal) => {
            // meal.date should always be set for multi-day plans generated by the AI meal-plan route.
            // Fall back to start_date only for legacy single-day plan entries that lack a date field.
